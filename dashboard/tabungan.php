...
<div class="container">
  <div class="col-md-8 col-md-offset-2">
    <form class="form-horizontal" action="tabungan.php" method="get">
      <fieldset>
        <div class="form-group">
          ...
          <div class="col-sm-10">
            ...
            <input type="checkbox" name="pin" value="Kembali" data-toggle="toggle" data-on="Tabung" data-off="Tarik" data-onstyle="success" data-offstyle="danger" checked>
          </div>
        </div>
        <div class="form-group">
    ...
    <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action">
      ...
      <tbody>
        <tr>
          ...
          <td>USD</td>
          <td>61</td>
          <td><a href='tabungan.php?act=2&id=1&pin=Tabung&kel=1&cur=USD&jum=61'><span class='glyphicon glyphicon-pencil'></span></a></td>
          <td><a href='tabungan.php?act=3&id=1&pin=Tabung&kel=1&cur=USD&jum=61'><span class='glyphicon glyphicon-remove'></span></a></td>
        </tr>
        <tr>
          <td><input type="checkbox" class="flat"></td>
          <td>2</td>
          ...
          <td>IDR</td>
          <td>100</td>
          <td><a href='tabungan.php?act=2&id=2&pin=Tabung&kel=4&cur=IDR&jum=100'><span class='glyphicon glyphicon-pencil'></span></a></td>
          <td><a href='tabungan.php?act=3&id=2&pin=Tabung&kel=4&cur=IDR&jum=100'><span class='glyphicon glyphicon-remove'></span></a></td>
        </tr>
        <tr>
          <td><input type="checkbox" class="flat"></td>
          <td>3</td>
          ...
          <td>SGD</td>
          <td>20</td>
          <td><a href='tabungan.php?act=2&id=3&pin=Tarik&kel=8&cur=SGD&jum=20'><span class='glyphicon glyphicon-pencil'></span></a></td>
          <td><a href='tabungan.php?act=3&id=3&pin=Tarik&kel=8&cur=SGD&jum=20'><span class='glyphicon glyphicon-remove'></span></a></td>
        </tr>
      </tbody>
    </table>
  </div>
