...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 20, 2017 at 02:43 PM
...
(1, 'BenangMerah', 130, 50, 50, 1, 785, 1000, 1000, 785, 1000, 1000),
(2, 'BenangKuning', 50, 68, 50, 1, 1000, 753, 1000, 753, 753, 1000),
(3, 'BenangBiru', 50, 50, 36, 1, 1000, 1000, 749, 749, 1000, 749),
(4, 'Template', 130, 106, 141, 3, 924, 927, 916, 924, 927, 916),
...
(10, '1M 1K 1B', 690, 709, 697, 7, 7, 0, 7, 8, 0);
...
(434, 0, 10371, 4641, 7564, 0, 0, 0),
(435, 0, 8926, 5942, 5109, 0, 0, 0),
(436, 0, 8743, 5478, 6805, 0, 0, 0),
(437, 0, 6720, 3313, 6961, 0, 0, 0),
(438, 0, 5723, 4195, 7751, 0, 0, 0),
(439, 0, 6066, 4195, 8669, 0, 0, 0);
...
(134, 1, 1, 1, 100, 'RMB', 9),
(136, 1, 1, 1, 150, 'RMB', 13),
(137, 12, 3, 3, 280, 'SGD', 3),
(138, 1, 1, 2, 300, 'IDR', 8),
(139, 18, 2, 1, 120, 'IDR', 1),
(140, 15, 2, 3, 330, 'IDR', 8),
(141, 18, 2, 1, 125, 'IDR', 1),
(142, 18, 2, 1, 130, 'IDR', 2),
(143, 5, 1, 1, 150, 'RMB', 7),
(144, 12, 3, 1, 90, 'IDR', 4),
(145, 14, 4, 1, 120, 'IDR', 8),
(146, 18, 2, 1, 150, 'SGD', 12),
(148, 13, 3, 1, 150, 'RMB', 4),
(149, 2, 2, 1, 200, 'RMB', 9),
(150, 15, 2, 3, 350, 'RMB', 4),
(151, 5, 1, 1, 160, 'RMB', 13),
(152, 18, 2, 1, 150, 'SGD', 2),
(153, 18, 2, 1, 150, 'RMB', 11),
(154, 15, 2, 2, 250, 'RMB', 12),
(155, 5, 1, 1, 170, 'RMB', 9),
(157, 20, 2, 3, 300, 'RMB', 13),
(158, 9, 3, 3, 400, 'RMB', 15),
(159, 11, 3, 1, 150, 'RMB', 4),
(160, 1, 1, 1, 150, 'RMB', 9),
(161, 1, 1, 1, 125, 'RMB', 13),
(162, 20, 2, 3, 400, 'RMB', 1),
(164, 18, 2, 1, 150, 'SGD', 0),
(165, 12, 2, 1, 140, 'SGD', 0),
(166, 18, 2, 1, 150, 'RMB', 9),
(167, 5, 1, 1, 175, 'RMB', 9),
(168, 5, 1, 1, 180, 'RMB', 8),
(169, 15, 2, 3, 360, 'RMB', 9),
(171, 1, 1, 1, 150, 'SGD', 12),
(173, 11, 3, 1, 180, 'RMB', 0),
(174, 1, 1, 1, 150, 'SGD', 0),
(175, 1, 1, 1, 150, 'SGD', 0),
(176, 7, 3, 1, 150, 'IDR', 1),
(177, 19, 3, 1, 117, 'SGD', 20);
...
(1, 'tim1', 'tim1', 564, 351, 91, 50),
(2, 'tim2', 'tim2', 0, 0, 0, 50),
(3, 'tim3', 'tim3', 682, 65, 215, 50),
(4, 'tim4', 'tim4', 467, 2021, 842, 50),
(5, 'tim5', 'tim5', 226, 372, 385, 50),
(6, 'tim6', 'tim6', 0, 0, 0, 50),
(7, 'tim7', 'tim7', 150, 68, 1345, 50),
(8, 'tim8', 'tim8', 0, 19, 282, 50),
(9, 'tim9', 'tim9', 0, 0, 723, 50),
(10, 'tim10', 'tim10', 0, 0, 0, 50),
(11, 'tim11', 'tim11', 315, 72, 380, 50),
(12, 'tim12', 'tim12', 197, 148, 123, 50),
(13, 'tim13', 'tim13', 57, 35, 2256, 50),
(14, 'tim14', 'tim14', 0, 0, 9, 50),
(15, 'tim15', 'tim15', 1387, 1348, 1105, 50),
(16, 'tim16', 'tim16', 1209, 77, 295, 50),
(17, 'tim17', 'tim17', 0, 0, 0, 50),
(18, 'tim18', 'tim18', 422, 26, 501, 50),
(19, 'tim19', 'tim19', 280, 302, 117, 50),
(20, 'tim20', 'tim20', 110, 0, 0, 50);
...
--
ALTER TABLE `hargasaham`
  MODIFY `idhargasaham` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=440;
--
-- AUTO_INCREMENT for table `inventory`
--
ALTER TABLE `inventory`
  MODIFY `idinventory` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1444;
--
-- AUTO_INCREMENT for table `onsale`
--
ALTER TABLE `onsale`
  MODIFY `idonsale` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=178;
--
-- AUTO_INCREMENT for table `pembelian`
--
ALTER TABLE `pembelian`
  MODIFY `idpembelian` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=337;
--
-- AUTO_INCREMENT for table `penjualan`
--
ALTER TABLE `penjualan`
  MODIFY `idpenjualan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=185;
--
...
--
ALTER TABLE `tcurrency`
  MODIFY `idtcurrency` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
--
...
--
ALTER TABLE `tpinjaman`
  MODIFY `idtpinjaman` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=318;
--
...
--
ALTER TABLE `ttabungan`
  MODIFY `idttabungan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;
--
